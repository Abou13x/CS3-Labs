...
int main() {
    ...
    olaf.subscribe(sue.getName()); olaf.subscribe(steve.getName());//subscribing using subject's name
    ...
    olga.unsubscribe(sue.getName());//unsubscribing using subject's name
    sue.generateMessage();
